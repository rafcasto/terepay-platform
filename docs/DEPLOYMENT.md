...
QIPPAY_PAYBY_APPROVE_PATH=/v1/approve_payment  # PayBy *Embedded* approve endpoint (early repayment) — CONFIRM against the PayBy Embedded spec; default is a best-guess
```
