    ...
    <div className="space-y-5">
      ...
      >
        <div className="grid gap-4 md:grid-cols-4">
          ...
          <Field label="Interest rate (% p.a., e.g. 49 — not the 4.74% total over the term)"><input type="number" min={0} step="0.01" value={app.interest_rate ?? ''} onChange={(e) => setField('interest_rate', num(e.target.value))} className={`${inputCls} w-full`} /></Field>
