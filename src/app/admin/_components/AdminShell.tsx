...
export default function AdminShell({ children, showEnvReset }: { children: ReactNode; showEnvReset: boolean }) {
      ...
      <div className="flex flex-1">
        ...
        <aside className="hidden sm:flex w-64 bg-[#0F1D2E] flex-col shrink-0">
          ...
          <div className="px-3 pb-4 space-y-0.5 border-t border-white/10 pt-3">
            {/* Env Reset — only visible when env_reset_enabled flag is ON */}
            {showEnvReset && (
              <Link
