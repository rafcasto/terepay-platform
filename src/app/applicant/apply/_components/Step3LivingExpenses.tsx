  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-surface-sunken rounded-xl border border-border-default p-4">
        <h3 className="text-sm font-semibold text-ink-strong mb-3">
        ...
        <div className="flex items-center gap-3 pt-3 mt-1 border-t border-border-default">
          <span className="text-sm font-semibold text-ink-strong flex-1">Total Non-Discretionary</span>
          <span className="w-32 shrink-0 px-3 py-2 bg-brand-soft text-brand-text font-bold text-sm rounded-md text-right">
            ${sumNd.toFixed(2)}
          </span>
        </div>
      </div>
      ...
      <div className="bg-surface-sunken rounded-xl border border-border-default p-4">
        ...
        <div className="flex items-center gap-3 pt-3 mt-1 border-t border-border-default">
          <span className="text-sm font-semibold text-ink-strong flex-1">Total Discretionary</span>
          <span className="w-32 shrink-0 px-3 py-2 bg-brand-soft text-brand-text font-bold text-sm rounded-md text-right">
            ${sumD.toFixed(2)}
          </span>
        </div>
      ...
      <div className="bg-surface-sunken rounded-xl border border-border-default p-4">
        <h3 className="text-sm font-semibold text-ink-strong mb-3">Subscription Details</h3>
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-3 pt-3 border-t border-border-default">
            <span className="text-sm font-semibold text-ink-strong flex-1">Total Subscriptions</span>
            <span className="px-3 py-2 bg-brand-soft text-brand-text font-bold text-sm rounded-md">
              ${sumSubs.toFixed(2)}
            </span>
          </div>
        </div>
      ...
      <div className="bg-surface-sunken rounded-xl border border-border-default p-4">
        ...
        <div className="flex items-center gap-3 pt-3 mt-1 border-t border-border-default">
          <span className="text-sm font-semibold text-ink-strong flex-1">Total BNPL</span>
          <span className="w-32 shrink-0 px-3 py-2 bg-brand-soft text-brand-text font-bold text-sm rounded-md text-right">
            ${sumBnpl.toFixed(2)}
          </span>
        </div>
